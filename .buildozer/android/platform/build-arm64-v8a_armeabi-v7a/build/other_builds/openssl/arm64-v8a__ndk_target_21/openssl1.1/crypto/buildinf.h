...
#define DATE "built on: Tue Jul  5 05:57:58 2022 UTC"
...
static const char compiler_flags[] = {
    ...
    '_','=','2','1',' ','-','I','/','h','o','m','e','/','g','i','t',
    'p','o','d','/','.','b','u','i','l','d','o','z','e','r','/','a',
